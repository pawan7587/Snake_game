...
class SnakeGame:
    ...
    def draw(self):
        ...
        #self.window.draw_rect((75, 75, 75), (270,300), (30, 30))
        #self.window.draw_rect((75, 75, 75), (300,300), (30, 30))
        #self.window.draw_rect((75, 75, 75), (300,330), (30, 30))
        for part in self.snake:
            coordinates = part.get_coordinates()
            size = part.get_size()
            colour = part.get_colour()
            self.window.draw_rect(colour,coordinates,size)
